// Generated by SolidPython 1.1.3 on 2026-02-21 20:02:05
...
union() {
	union() {
		difference() {
			...
			union() {
				translate(v = [66.0000000000, 18.0000000000, 17.5000000000]) {
					linear_extrude(height = 1.0100000000) {
						rotate(a = [0, 0, 90]) {
							text(halign = "center", size = 2.8333333333, text = "70000-SD-1", valign = "center");
						}
					}
				}
				translate(v = [89.0000000000, 71.0000000000, 17.5000000000]) {
					linear_extrude(height = 1.0100000000) {
						rotate(a = [0, 0, 90]) {
							text(halign = "center", size = 2.8333333333, text = "70123-SD-1", valign = "center");
						}
					}
				}
				translate(v = [133.5000000000, 71.0000000000, 17.5000000000]) {
					linear_extrude(height = 1.0100000000) {
						rotate(a = [0, 0, 90]) {
							text(halign = "center", size = 2.8333333333, text = "70123-SD-1", valign = "center");
						}
				...
				translate(v = [46.0000000000, 104.0000000000, 17.5000000000]) {
					linear_extrude(height = 1.0100000000) {
						rotate(a = [0, 0, 90]) {
							text(halign = "center", size = 2.8333333333, text = "70123-SD-1", valign = "center");
						}
				...
				translate(v = [90.5000000000, 104.0000000000, 17.5000000000]) {
					linear_extrude(height = 1.0100000000) {
						rotate(a = [0, 0, 90]) {
							text(halign = "center", size = 2.8333333333, text = "70123-SD-1", valign = "center");
						}
				...
				translate(v = [135.0000000000, 104.0000000000, 17.5000000000]) {
					linear_extrude(height = 1.0100000000) {
						rotate(a = [0, 0, 90]) {
							text(halign = "center", size = 2.8333333333, text = "70123-SD-1", valign = "center");
						}
				...
				translate(v = [46.0000000000, 127.0000000000, 17.5000000000]) {
					linear_extrude(height = 1.0100000000) {
						rotate(a = [0, 0, 90]) {
							text(halign = "center", size = 2.8333333333, text = "70123-SD-1", valign = "center");
						}
				...
				translate(v = [90.5000000000, 127.0000000000, 17.5000000000]) {
					linear_extrude(height = 1.0100000000) {
						rotate(a = [0, 0, 90]) {
							text(halign = "center", size = 2.8333333333, text = "70123-SD-1", valign = "center");
						}
				...
				translate(v = [135.0000000000, 127.0000000000, 17.5000000000]) {
					linear_extrude(height = 1.0100000000) {
						rotate(a = [0, 0, 90]) {
							text(halign = "center", size = 2.8333333333, text = "70123-SD-1", valign = "center");
						}
				...
				translate(v = [46.0000000000, 150.0000000000, 17.5000000000]) {
					linear_extrude(height = 1.0100000000) {
						rotate(a = [0, 0, 90]) {
							text(halign = "center", size = 2.8333333333, text = "70123-SD-1", valign = "center");
						}
				...
				translate(v = [90.5000000000, 150.0000000000, 17.5000000000]) {
					linear_extrude(height = 1.0100000000) {
						rotate(a = [0, 0, 90]) {
							text(halign = "center", size = 2.8333333333, text = "70123-SD-1", valign = "center");
						}
