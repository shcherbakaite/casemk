// Generated by SolidPython 1.1.3 on 2026-02-21 18:26:42


difference() {
	linear_extrude(height = 43.5000000000) {
		offset(r = 5.0000000000) {
			square(size = [190.0000000000, 190.0000000000]);
		}
	}
	union() {
		translate(v = [8.0000000000, 8.0000000000, 2.0000000000]) {
			cube(size = [101.5000000000, 101.5000000000, 41.5100000000]);
		}
		translate(v = [111.0000000000, 8.0000000000, 2.0000000000]) {
			cube(size = [41.5000000000, 31.5000000000, 41.5100000000]);
		}
		translate(v = [8.0000000000, 111.0000000000, 2.0000000000]) {
			cube(size = [41.5000000000, 31.5000000000, 41.5100000000]);
		}
		translate(v = [51.0000000000, 111.0000000000, 2.0000000000]) {
			cube(size = [31.5000000000, 21.5000000000, 41.5100000000]);
		}
		translate(v = [84.0000000000, 111.0000000000, 2.0000000000]) {
			cube(size = [31.5000000000, 21.5000000000, 41.5100000000]);
		}
		translate(v = [117.0000000000, 111.0000000000, 2.0000000000]) {
			cube(size = [31.5000000000, 21.5000000000, 41.5100000000]);
		}
		translate(v = [150.0000000000, 111.0000000000, 2.0000000000]) {
			cube(size = [31.5000000000, 21.5000000000, 41.5100000000]);
		}
		translate(v = [8.0000000000, 144.0000000000, 2.0000000000]) {
			cube(size = [31.5000000000, 21.5000000000, 41.5100000000]);
		}
		translate(v = [41.0000000000, 144.0000000000, 2.0000000000]) {
			cube(size = [31.5000000000, 21.5000000000, 41.5100000000]);
		}
		translate(v = [74.0000000000, 144.0000000000, 2.0000000000]) {
			cube(size = [31.5000000000, 21.5000000000, 41.5100000000]);
		}
		translate(v = [107.0000000000, 144.0000000000, 2.0000000000]) {
			cube(size = [31.5000000000, 21.5000000000, 41.5100000000]);
		}
		translate(v = [140.0000000000, 144.0000000000, 2.0000000000]) {
			cube(size = [31.5000000000, 21.5000000000, 41.5100000000]);
		}
		translate(v = [8.0000000000, 167.0000000000, 2.0000000000]) {
			cube(size = [31.5000000000, 21.5000000000, 41.5100000000]);
		}
	}
}
